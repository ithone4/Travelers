...
function DocumentGenerator(props) {
  ...
  let demoData = [
    {
      header: "Purpose",
      Paragraphs: ["This policy governs the principles under which ACME employees must travel, conduct meetings and expense, and incur business expenses and claim reimbursements. In addition to providing rules, it highlights which practices keep the traveler the most safe, ways to find savings, how to improve experience on trip, and how to be more sustainable.", "To help reduce the environmental impact of our travel, travel on ACME company business must only occur when it adds significant value, that cannot be accomplished through means such as phone or video conferencing (e.g. Zoom, Webex).", "This policy applies to all ACME employees, globally, for travel undertaken by employees away from their office location or normal place of work. Violators may be subject to disciplinary action, up to and including termination of employment.", "When booking a trip with the Travel Agency or Online Booking Tool (OBT), you may be asked for your purpose of trip, and then the reason for you selecting the airline and hotels you have selected. Please answer as suitably as possible, as doing so helps improve the offerings that ACME can offer Team Members who travel.", "To help reduce the environmental impact of our travel, we encourage team members to combine trips and do multiple meetings in a destination, or to travel from one destination directly to the next."]
    },
    {
      header: "Booking/TMC",
